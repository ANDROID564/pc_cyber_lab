...
#take frames from video_file
        ...
        try:
            if not os.path.exists('z1video_frames2'):
                os.makedirs('z1video_frames2')
        except OSError:
...
# Load the Tensorflow model into memory.
    ...
    # Saves image of the current frame in jpg file
                    name = './z1video_frames2/frame' + str(currentFrame) + '.jpg'
                    print ('Creating...' + name)
...
# Clean up 
    ...
    #cv2.imshow('Object detector', (detect('2.avi')))
