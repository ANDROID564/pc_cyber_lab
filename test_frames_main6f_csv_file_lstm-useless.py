...
def accuracy(Accuracy):
    ...
    print(colored("accuracy of prediction",'blue'),accuracy1)
    
    for i in accuracy1:
        #i=(i+1)-i
        print(colored("accuracy of prediction",'blue'),i)
...
def plot_graph():
    ...
    sensitive_x=327
    sensitive_y=285
    total_distance=math.sqrt((abs(sensitive_x) - abs(xs[0]))**2 + (abs(sensitive_y) - abs(ys[0]))**2)
    print("total_distance initially",total_distance)
    total_frames=(total_distance)*1/36
    ...
    with myFile:    
        ...
        for i,j in zip(xs,ys):    
            ...
            #The distance is found 
            Distance=math.sqrt((abs(sensitive_x) - abs(i))**2 + (abs(sensitive_y) - abs(j))**2)
            
            #The speed is found
            if (total_frames>0):     
                Speed=Distance/total_frames-k
                k=k+1
            else:
                Speed=Distance/total_frames_count+h
                h=h+1
